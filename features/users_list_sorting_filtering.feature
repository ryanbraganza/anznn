Feature: Administer users
  ...
  Background:
    ...
    And I have users
      ...
      | fred@intersect.org.au | Fred       | Jones     | 2011-12-21 14:56 |
      | dan@intersect.org.au  | TheManDan  | Superuser |                  |
      | anna@intersect.org.au | Anna       | Smith     |                  |
    And I have hospitals
      | state | name       | abbrev |
      | NSW   | Left Wing  | Left   |
      | Vic   | Right Wing | Right  |
      | Vic   | Only Wing  | OWing  |
    And "dan@intersect.org.au" has role "Administrator"
    And "fred@intersect.org.au" has role "Data Provider Supervisor"
    And "anna@intersect.org.au" has role "Data Provider"
    And "fred@intersect.org.au" has hospital "Left Wing"
    And "anna@intersect.org.au" has hospital "Right Wing"
