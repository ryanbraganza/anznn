Feature: View a list of batch files
  ...
  Background:
    ...
    And I have batch uploads
      | survey    | created_by                     | created_at       | status      | message   | hospital | summary report | detail report | file_file_name |
      | MySurvey  | data.provider@intersect.org.au | 2012-01-03 13:56 | In Progress | Message 1 | RPA      | false          | false         | first.csv      |
      | MySurvey2 | data.provider@intersect.org.au | 2012-01-04 13:56 | In Progress | Message 2 | Randwick | false          | false         | second.csv     |
      | MySurvey  | supervisor@intersect.org.au    | 2012-01-03 08:00 | Succeeded   | Message 3 | Randwick | true           | false         | third.csv      |
      | MySurvey2 | supervisor@intersect.org.au    | 2012-01-03 11:23 | Failed      | Message 4 | RPA      | true           | true          | fourth.csv     |
  ...
  Scenario: View a list of batch uploads - superuser sees all
    ...
    Then I should see "batch_uploads" table with
      | Survey Type | Filename   | Created By    | Date Uploaded          | Status      | Details   | Reports                       |
      | MySurvey2   | second.csv | Data Provider | January 04, 2012 13:56 | In Progress | Message 2 |                               |
      | MySurvey    | first.csv  | Data Provider | January 03, 2012 13:56 | In Progress | Message 1 |                               |
      | MySurvey2   | fourth.csv | Fred Smith    | January 03, 2012 11:23 | Failed      | Message 4 | Summary Report\nDetail Report |
      | MySurvey    | third.csv  | Fred Smith    | January 03, 2012 08:00 | Succeeded   | Message 3 | Summary Report                |
