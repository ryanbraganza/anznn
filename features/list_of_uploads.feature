Feature: View a list of batch files
  ...
  Background:
    ...
    And I have batch uploads
      | survey    | created_by                     | created_at       | status      | message   | hospital | summary report | detail report | file_file_name | record_count |
      ...
      | MySurvey  | supervisor@intersect.org.au    | 2012-01-03 08:00 | Succeeded   | Message 3 | Randwick | true           | false         | third.csv      | 15           |
      | MySurvey2 | supervisor@intersect.org.au    | 2012-01-03 11:23 | Failed      | Message 4 | RPA      | true           | true          | fourth.csv     | 20           |
  ...
  Scenario: View a list of batch uploads - superuser sees all
    ...
    Then I should see "batch_uploads" table with
      ...
      | MySurvey    | third.csv  | Fred Smith    | January 03, 2012 08:00 | 15          | Succeeded   | Message 3 | Summary Report                |
