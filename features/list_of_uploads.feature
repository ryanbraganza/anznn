Feature: View a list of batch files
  ...
  Background:
    ...
    And I have batch uploads
      | survey    | created_by                     | created_at       | status      | message   | hospital | report |
      | MySurvey  | data.provider@intersect.org.au | 2012-01-03 13:56 | In Progress | Message 1 | RPA      | false  |
      | MySurvey2 | data.provider@intersect.org.au | 2012-01-04 13:56 | In Progress | Message 2 | Randwick | false  |
      | MySurvey  | supervisor@intersect.org.au    | 2012-01-03 08:00 | Succeeded   | Message 3 | Randwick | true   |
      | MySurvey2 | supervisor@intersect.org.au    | 2012-01-03 11:23 | Failed      | Message 4 | RPA      | true   |
  ...
  Scenario: View a list of batch uploads - superuser sees all
    ...
    Then I should see "batch_uploads" table with
      | Survey Type | Created By    | Date Uploaded          | Status      | Details   | Reports        |
      ...
      | MySurvey2   | Fred Smith    | January 03, 2012 11:23 | Failed      | Message 4 | Summary Report |
      | MySurvey    | Fred Smith    | January 03, 2012 08:00 | Succeeded   | Message 3 | Summary Report |
  ...
  Scenario: Download a summary report
    ...
    Then I should receive a pdf with name "summary-report.pdf"
